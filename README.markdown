...
- **Adaptive Testing**: Adjusts question difficulty (increases for correct, decreases for incorrect) without repeating questions within a session.
...
- **No Question Repeats**: Questions are guaranteed not to repeat within a 10-question test session, improving test integrity.
...
- Answer 10 unique questions (no repeats) by clicking an option; the selected option is highlighted in bright blue (1525D1) until "Next" is clicked.
...
- Questions are guaranteed not to repeat within a 10-question test session, addressing issues like repeated "How can a leader resolve team conflicts?" in the yearbook test.
